...
INSTALL_ROOTFS=""
INSTALL_MODULES=""
INSTALL_INITRAMFS="${ARTIFACTS_DIR}/nucleo-t-builder-initramfs-genericx86-64.cpio.gz"
...
HDINSTALL_ROOTFS="${ARTIFACTS_DIR}/nucleo-t-graphical-builder-genericx86-64.tar.bz2 \
                  ${ARTIFACTS_DIR}/nucleo-t-builder-genericx86-64.tar.bz2"
...
EVAL_NAME="Evaluation - Wind River Nucleo-T"
